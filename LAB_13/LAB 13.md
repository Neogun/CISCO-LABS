...
**Лучший практикой будет отключить CDP полностью, так как в основом он нужен только при проектировании и реализации сети.
Но в целом, его надо отключать на интерфейсах к которым подключаются пользователи, внешние организации. Чтобы они не могли перехватывать CDP пакеты.**
